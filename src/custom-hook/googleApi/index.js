...
export const usePlaces = e => {
    ...
    useEffect(() => {
        fetch(fetch('https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=38.3890815,-0.5352448&radius=1500&type=restaurant&key=AIzaSyDU_rTJMBQ3rp8BRMiqFb9_sgd4AsxOJ-E'))
            .then(r => r.json())
            .then(d => {
